...
public class SampleOptionWindow extends Template {
    ...
    void setMenu() {
        ...
        roomLabel.setBounds(new Rectangle(0,0,200,200));
        ...
        roomLabel.setIcon(MainGUI.scaleImageIcon("imgs/menu/room.png",200,200));
        ...
        timeLabel.setBounds(new Rectangle(0,0,200,200));
        ...
        timeLabel.setIcon(MainGUI.scaleImageIcon("imgs/menu/clock.png",200,200));
        ...
        gameLabel.setBounds(new Rectangle(0,0,200,200));
        ...
        gameLabel.setIcon(MainGUI.scaleImageIcon("imgs/menu/boardgame.png",200,200));
        ...
        foodLabel.setBounds(new Rectangle(0,0,200,200));
        ...
        foodLabel.setIcon(MainGUI.scaleImageIcon("imgs/menu/food.png",200,200));
